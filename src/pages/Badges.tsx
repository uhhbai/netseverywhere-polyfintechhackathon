              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {badge.isUnlocked && (
                      <Badge className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white">Unlocked</Badge>
                    )}
                  </div>
                  ...
                  {badge.isUnlocked && (
                    <div className="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                      <h4 className="text-sm font-medium text-green-800 mb-1">🎁 Badge Benefits:</h4>
                      <div className="text-xs text-green-700">
                        {badge.category === 'streak' && '• 2% extra cashback on all payments'}
                        {badge.category === 'spending' && '• Access to exclusive merchant deals'}
                        {badge.category === 'activity' && '• Priority customer support'}
                        {badge.category === 'milestone' && '• $5 bonus credit to your account'}
                        {badge.category === 'special' && '• VIP status & special offers'}
                      </div>
                    </div>
                  )}
                  ...
                  {!badge.isUnlocked && badge.maxProgress && (
                    <div className="space-y-2">
                      ...
                      <div className="text-xs text-muted-foreground">
                        🎁 Unlock reward: 
                        {badge.category === 'streak' && ' 2% extra cashback'}
                        {badge.category === 'spending' && ' Exclusive deals'}
                        {badge.category === 'activity' && ' Priority support'}
                        {badge.category === 'milestone' && ' $5 bonus credit'}
                        {badge.category === 'special' && ' VIP status'}
                      </div>
                    </div>
                  )}
