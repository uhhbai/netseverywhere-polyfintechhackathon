...
const MyQrPage = () => {
  ...
  return (
    <MobileFrame>
      <Header title="NETS QR Payment" />
      
      <div className="flex-1 p-6 space-y-6 pb-24">
        {/* Header Card */}
        <div className="bg-gradient-primary text-white p-6 rounded-2xl text-center">
          <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4">
            <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
            </svg>
          </div>
          <h1 className="text-xl font-bold mb-2">Generate Payment QR</h1>
          <p className="text-white/80">Create QR codes for instant NETS payments</p>
        </div>

        {/* Payment Container */}
        <div className="bg-card rounded-2xl p-6 shadow-elegant border border-card-border space-y-6">
          {/* Idle → QR form */}
          {txnStatus === "idle" && (
